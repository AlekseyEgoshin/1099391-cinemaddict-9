...
export class FilmPopupMiddleBlock extends AbstractComponent {
  ...
  getTemplate() {
    return `<div class="form-details__middle-container ${this._userDetails.alreadyWatched ? `` : `visually-hidden`}">
